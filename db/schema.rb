...
ActiveRecord::Schema.define(version: 2019_10_07_192055) do
  ...
  create_table "personal_records", force: :cascade do |t|
    ...
    t.index ["user_id", "movement_id", "date"], name: "index_personal_records_on_user_id_and_movement_id_and_date", unique: true
  end
